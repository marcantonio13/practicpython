...
def iniciar():
    while True: 
        ...
        if opcion == '1':
            ...
            dni = helpers.leer_texto(3, 3, "DN!(2 int y 1 char)").upper()
            nombre = helpers.leer_texto(3, 30, "Nombre ( de 2 a 30 caracteres)").capitalize()
            ...
            dni = helpers.leer_texto(3, 3, "DN!(2 int y 1 char)").upper()
            print("Cliente borado correctamente.") if db.Clientes.borrar(dni) else print("Cleinte no encontrado")
